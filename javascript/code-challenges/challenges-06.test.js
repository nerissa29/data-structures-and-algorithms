...
// uses MDN Docs for map(), reverse(0, and join())
const getNames = (arr) => {
  // uses map to iterate through the arrays and return new array
  let strReverse = arr.map(element => element.name.split('').reverse().join(''));
  return strReverse;
};
